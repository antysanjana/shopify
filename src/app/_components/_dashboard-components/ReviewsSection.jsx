  ...
  const testimonials = [
    {
      ...
      name: "Richard",
      link: "https://www.thecoffeemugshop.de/",
    ...
    },
    {
      ...
      name: "Stognarelli",
      link: "https://parfumunglaublich.ch/",
    ...
    },
    {
      ...
      name: "Monique",
      link: "https://www.naehmaschinen-liebling.de",
      ...
      <div className="columns-1 md:columns-2 gap-5 mt-10">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <h2 className="font-xl font-bold color-secondary mt-3">
              {testimonial.name}
            </h2>
            <a
              ...
              className="text-decoration-underline text-blue-600 font-bold"
            >
              <span className="text-sm">{testimonial.siteDescription}</span>
            </a>
            <span>👉</span>
          </div>
        ))}
